...
proc Actions*(): void =
  ...
  stdout.write("{yellow}'s in any{reset} '{green}name{reset}' {yellow}given as an argument to the{reset} {cyan}find:{reset}{yellow} action, is{reset} {red}invalid.{reset}\n".fmt)
  stdout.flushFile
  ...
  stdout.writeLine("\n {cyan}append{reset}:{green}text{reset}\t\t\t {yellow}append text to the{reset} '{green}file{reset}' {yellow}given to the{reset} '{cyan}open{reset}:' {yellow}action{reset}".fmt)
  stdout.flushFile
  ...
  stdout.writeLine("\n {cyan}entryinfo{reset}:{green}entry{reset}\t\t {yellow}get info for a {reset}{blue}File{reset} {yellow}or{reset} {blue}Directory{reset} '{green}entry{reset}'".fmt)
  stdout.flushFile
  ...
  stdout.writeLine("\n {cyan}open{reset}:{green}file{reset}\t\t\t {yellow}open the given{reset} '{green}file{reset}' {yellow}for{reset} '{cyan}writing{reset}' {yellow}or{reset} '{cyan}appending{reset}'".fmt)
  stdout.flushFile
  ...
  stdout.writeLine("\n {cyan}write{reset}:[{green}file{reset}|{green}text{reset}]\t\t {yellow}the{reset} '{green}file{reset}' {yellow}to be written to or the{reset} '{green}text{reset}' {yellow}that should be written{reset}".fmt)
  stdout.flushFile

  stdout.writeLine("\n      :{green}file{reset}\t\t\t {yellow}write the contents of the{reset} '{cyan}find{reset}:' {yellow}action{reset} {yellow}to the given{reset} '{green}file{reset}'".fmt)
  stdout.flushFile

  stdout.writeLine("\n      :{green}text{reset}\t\t\t {yellow}write the text to the{reset} '{green}file{reset}' {yellow}given to the{reset} '{cyan}open{reset}:' {yellow}action{reset}".fmt)
  stdout.flushFile
